...
// --- Begin: Customers Table Bookings Closed Schema --- //
...
}, {collection: config.collCustsTableBookingsClsd});
...
schema.index({idSeq: 1, branch: 1, user: 1, delFlag: -1, offer: 1});
schema.index({cDtTm: -1, cDtStr: -1, uDtTm: -1, uDtStr: -1, bDtStr: -1});

module.exports = mongoose.model(config.collCustsTableBookingsClsd, schema);
// --- End: Customers Table Bookings Closed Schema --- //
