...
// --- Begin: Dashbrd Month Anltcs Schema --- //
const schema = new Schema({
  ...
  rDtStr: {type: String, required: true}, // Reservation Date String: YYYY-MM
  slot: {type: String, required: false}, // Booking Slot Lunch, Dinner
...
}, {collection: config.collDashboardsMnthly});
...
module.exports = mongoose.model(config.collDashboardsMnthly, schema);
// --- End: Dashbrd Month Anltcs Schema --- //