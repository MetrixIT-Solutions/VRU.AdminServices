...
// --- Begin: Dashbrd Year Anltcs Schema --- //
const schema = new Schema({
  ...
  rDate: {type: Date, required: true}, // Reservation Date: YYYY
  rDtStr: {type: String, required: true}, // Reservation Date String: YYYY
...
}, {collection: config.collDashboardsYrly});
...
module.exports = mongoose.model(config.collDashboardsYrly, schema);
// --- End: Dashbrd Year Anltcs Schema --- //