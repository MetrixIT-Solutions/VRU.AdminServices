...
// --- Begin: Customers Table Bookings Absents Schema --- //
...
module.exports = mongoose.model(config.collCustsTableBookingsAbsents, schema);
// --- End: Customers Table Bookings Absents Schema --- //
