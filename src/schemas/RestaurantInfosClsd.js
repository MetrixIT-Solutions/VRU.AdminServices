...
// --- Begin: Restaurant Informations Closed Schema --- //
...
module.exports = mongoose.model(config.collRestaurantInfosClsd, schema);
// --- End: Restaurant Informations Closed Schema --- //
